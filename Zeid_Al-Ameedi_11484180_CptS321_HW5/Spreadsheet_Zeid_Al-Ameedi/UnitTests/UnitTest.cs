...
namespace UnitTests
{
    ...
    public class UnitTest
    {
        ...
        /// <summary>
        /// The incorrect operand was taken care of by throwing an exception as well, which was nullreference
        /// </summary>
        [TestMethod]
        public void IncorrectOperandExpressionTree()
        {
            ExpressionTree t1 = new ExpressionTree("5^2");
            try
            {
                Assert.AreEqual(null, t1.Evaluate());
            }
            catch(NullReferenceException)
            {
                Assert.AreEqual(0, 0); //Meaning it passed since an exception was thrown
            }
        }
